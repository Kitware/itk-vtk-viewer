var DownsampleLabelImage = (() => {
  ...
  return function(DownsampleLabelImage) {
    ...
    var _main = (Module['_main'] = function() {
      return (_main = Module['_main'] = Module['asm']['B']).apply(
        null,
        arguments
      )
    })
    ...
    var stackSave = (Module['stackSave'] = function() {
      return (stackSave = Module['stackSave'] = Module['asm']['M']).apply(
        null,
        arguments
      )
    })
    ...
    var stackAlloc = (Module['stackAlloc'] = function() {
      return (stackAlloc = Module['stackAlloc'] = Module['asm']['O']).apply(
        null,
        arguments
      )
    })
