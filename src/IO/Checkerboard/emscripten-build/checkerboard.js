var checkerboard = (() => {
  ...
  return async function(checkerboard) {
    checkerboard = checkerboard || {}

    var Module = typeof checkerboard != 'undefined' ? checkerboard : {}
    ...
    var wasmBinaryFile
    if (Module['locateFile']) {
      wasmBinaryFile = 'checkerboard.wasm'
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile)
      }
    } else {
      wasmBinaryFile = new URL('checkerboard.wasm', import.meta.url).href
    }
